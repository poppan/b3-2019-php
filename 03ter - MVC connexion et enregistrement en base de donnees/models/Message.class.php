...
//            	echo 'HEY HO noramzemnt on update ici';
//                // update
//            }
			...
			$dbh = Connection::get();
			$sql = "
insert into messages (id, user_id, content) values (:id, :user_id, :content)
on duplicate key update modified=CURRENT_TIMESTAMP(), content=:content
";
			...
			if ($sth->execute(array(
				...
				echo('ca a sauvegardé c chelou');
				return true;
			} else {
				echo('ca a pas sauvegardé c super');
				// ERROR
